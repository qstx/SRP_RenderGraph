...
namespace LiteRP
{
    public partial class LiteRenderGraphRecorder
    {
        ...
        {
            using (var builder = renderGraph.AddRasterRenderPass<SetupCameraPropertiesPassData>("Setup Camera Properties", out var passData, s_SetupCameraPropertiesProfilingSampler))
            {
